"""Unit tests for DeckImportExportService.
...
Run this test file:
    docker compose exec backend pytest src/tests/test_deck_import_export_unit.py -v

Run with coverage:
    docker compose exec backend pytest src/tests/test_deck_import_export_unit.py --cov=services.deck_import_export_service
"""
...
class TestDeckExport:
    ...
    def test_export_to_json_success(self, sample_deck_data):
        ...
        result = DeckImportExportService.export_deck_to_json(sample_deck_data)
    ...
    def test_export_to_json_empty_cards(self):
        ...
        result = DeckImportExportService.export_deck_to_json(deck_data)
        data = json.loads(result)
        assert len(data["cards"]) == 0
    
    def test_export_to_csv_success(self, sample_deck_data):
        """Test successful CSV export"""
        result = DeckImportExportService.export_deck_to_csv(sample_deck_data)
    ...
    def test_export_to_csv_empty_cards(self):
        ...
        result = DeckImportExportService.export_deck_to_csv(deck_data)
        assert result == ""
    
    def test_export_to_anki_success(self, sample_deck_data):
        """Test successful Anki export"""
        result = DeckImportExportService.export_deck_to_anki(sample_deck_data)
    ...
    def test_export_to_anki_with_definition(self):
        ...
        result = DeckImportExportService.export_deck_to_anki(deck_data)
...
class TestDeckImport:
    ...
    def test_import_from_json_success(self, sample_deck_data):
        ...
        json_data = DeckImportExportService.export_deck_to_json(sample_deck_data)
        result = DeckImportExportService.import_deck_from_json(json_data)
    ...
    def test_import_from_json_invalid_format(self):
        ...
        with pytest.raises(ValueError, match="Invalid JSON format"):
            DeckImportExportService.import_deck_from_json("not valid json")
    ...
    def test_import_from_json_missing_deck_field(self):
        ...
        with pytest.raises(ValueError, match="Missing 'deck' or 'cards' field"):
            DeckImportExportService.import_deck_from_json(invalid_data)
...
adiós,goodbye,A farewell,Adiós,Goodbye,ah-dee-ohs,,"""
        ...
        result = DeckImportExportService.import_deck_from_csv(
    ...
    def test_import_from_csv_missing_required_columns(self):
        ...
        with pytest.raises(ValueError, match="must contain 'word' and 'translation' columns"):
            DeckImportExportService.import_deck_from_csv(csv_data, "Test", "es", "en")
...
adiós\tgoodbye"""
        ...
        result = DeckImportExportService.import_deck_from_anki(
...
word2\ttranslation2"""
        ...
        result = DeckImportExportService.import_deck_from_anki(anki_data, "Test", "es", "en")
        assert len(result["cards"]) == 2
    ...
    def test_import_from_anki_no_valid_cards(self):
        ...
        with pytest.raises(ValueError, match="No valid cards found"):
            DeckImportExportService.import_deck_from_anki(anki_data, "Test", "es", "en")
