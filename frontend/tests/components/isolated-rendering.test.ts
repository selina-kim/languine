...
describe("Feature Components - Exports", () => {
  ...
  test("should export TipsContainer", () => {
    const TipsContainer =
      require("@/components/features/help/TipsContainer").TipsContainer;
